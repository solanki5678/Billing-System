		...
		<div class="col-sm-8 col-xs-8">
				...
				<div class="field_wrapper">                                  
					...
					<div class="form-group">
									...
									Add your category
									<input type="text" class="form-control"  style="width:400px;height:45px"	name="category[]" required="" placeholder="Add menu" >
...
var fieldHTML = '<div> <input type="text" class="form-control" name="category[]" required="" style="width:400px;height:45px"id="exampleInputuname" placeholder="add more category"><br><a href="javascript:void(0);" class="remove_button"  style="float:right"stitle="Remove field"><button class="btn btn-danger">Remove</button></a></div>'; //New input field html 
